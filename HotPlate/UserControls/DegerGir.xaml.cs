...
{
    /// <summary>
    /// Interaction logic for NumericValue.xaml
    /// </summary>
    public partial class DegerGir : PLC_BaseUserControl
    {
        public DegerGir()
        {
            InitializeComponent();
        ...
        public bool Keypad
        {
            ...
            set
            {
                _keypad = value;
                if (!_keypad)
                    rec_read.Visibility = Visibility.Visible;
                if (_keypad)
                    rec_read.Visibility = Visibility.Hidden;
